...
public class TextMergeQuick
{
	...
	public static <T extends Comparable<? super T>>
	       void mergeSort(T[] a, int n, int min_size)
	{
		mergeSort(a, 0, n - 1, min_size);
	} // end mergeSort

	public static <T extends Comparable<? super T>>
	       void mergeSort(T[] a, int first, int last, int min_size)
	{
	  T[] tempArray = (T[])new Comparable<?>[a.length];
	  mergeSort(a, tempArray, first, last, min_size);
	} // end mergeSort
	
	private static <T extends Comparable<? super T>>
	        void mergeSort(T[] a, T[] tempArray, int first, int last, int min_size)
	{
	   ...
	   {  // sort each half
	      ...
	      mergeSort(a, tempArray, first, mid, min_size);  // sort left half array[first..mid]
	      mergeSort(a, tempArray, mid + 1, last, min_size); // sort right half array[mid+1..last]
...
// QUICK SORT
	...
	public static <T extends Comparable<? super T>>
	       void quickSort(T[] a, int first, int last, int min_size)
	{
	  if (last - first + 1 < min_size)
	  {
	    insertionSort(a, first, last);
